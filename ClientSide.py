...
((/ __|| |(_)((_)_ | |_ | _ \ ((_) ((_) _((_))  
 | (__ | ' \ / _` ||  _||   // _ \/ _ \| '  \() 
  \___||_||_|\__,_| \__||_|_\\___/\___/|_|_|_|  
                                               {colors.default}
    {colors.yellow}chat: {colors.default}v1.0.0      | {colors.yellow}Server:{colors.default} v1.0.0
...
ServerIPtoConnect = str(input(textDetails.systemMessage["System"]+" Server IP: ")).strip()
ServerAdressToConnect = (ServerIPtoConnect, 5050)
...
try: 
    ...
    while (nickname in [" ", ''] or nickname.isspace()):
        nickname = input(textDetails.systemMessage["System"]+" invalid Nickname! try again: ")
    os.system("cls")
